...
**已读回执、送达追踪、手机远程运维 ——
Claude Code、Codex、ChatGPT Web 等 12 种运行时，在同一个持久协作组里。**
...
| **多运行时编排** | Claude Code、Codex CLI、Devin CLI、Kiro CLI、Grok Build、OpenCode、ChatGPT Web 等 12 种一线运行时可混用，此外还支持 `custom` 运行时兜底 |
