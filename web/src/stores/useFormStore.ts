...
interface FormState {
  ...
  setEditActorExtraPrompt: (v: string) => void;
...
export const useFormStore = create<FormState>((set) => ({
  ...
  setEditActorExtraPrompt: (v) => set({ editActorExtraPrompt: v }),
  ...
  setNewActorExtraPrompt: (v) => set({ newActorExtraPrompt: v }),
