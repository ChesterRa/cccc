...
当前补验入口（2026-09-14）：[review15 合同](mattermost-im.md#当前修复合同2026-09-14review15)对应 `e34e00ed` 的完整评审。review14 及更早的结果保留为各自版本证据，不以旧 CI 绿灯代替本轮验证。
...
## 管理入口与在途请求顺序（2026-09-14，review15）
