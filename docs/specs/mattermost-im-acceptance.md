...
日期：2026-09-07，验收更新于 2026-09-08。对应 [规格](mattermost-im.md) 和 [功能清单](mattermost-im-features.md)。此前面向特定业务的验收表已被本表替代；**T01–T19 技术验证已完成，T20 已获用户明确确认“我已经验收完了，都正常”。本连接器验收完成；真实平台、协议模拟、共享回归和用户确认仍分别记录。现进入公开 Fork 源码提交及上游 Issue 阶段，验收完成不等于上游已合并或正式发布。**
