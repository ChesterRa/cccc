...
2026-09-14 review12：F02/F26 的旧管理动作与同配置请求隔离、F01/F27 的地址错误、F32 的公共 CLI 导航，以及 Web 跨 Group 异步管理结果的归属要求，统一见[当前合同](mattermost-im.md#当前修复合同2026-09-14review12)和[当轮验收](mattermost-im-acceptance.md#旧管理请求与异步表单交接2026-09-14review12)。历史验收不覆盖新增交接窗口。
