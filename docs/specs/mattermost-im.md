...
入口：[完整功能对照](mattermost-im-features.md)、[验收用例](mattermost-im-acceptance.md)、[领域用语](../../CONTEXT.md)、[架构决策](../adr/0001-native-mattermost-im.md)。
...
- 沿用上游“一个 Group 使用一个 Bot 凭据及组级 worker”的约定，不新增一个 Bot 跨多个 Group 的连接池和全局路由。
