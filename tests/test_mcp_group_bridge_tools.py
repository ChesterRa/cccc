...
class TestMcpGroupBridgeTools(unittest.TestCase):
    def test_remote_send_delegates_to_daemon(self) -> None:
        ...
        original = cccc_group_bridge._call_daemon_or_raise
        cccc_group_bridge._call_daemon_or_raise = fake_call  # type: ignore[assignment]
        try:
            out = cccc_group_bridge.remote_send(
                group_id="g_local",
                actor_id="actor-a",
            ...
            cccc_group_bridge._call_daemon_or_raise = original  # type: ignore[assignment]
    ...
    def test_delivery_status_delegates_to_daemon(self) -> None:
        ...
        cccc_group_bridge._call_daemon_or_raise = fake_call  # type: ignore[assignment]
        try:
            cccc_group_bridge.remote_delivery_status(
    ...
    def test_handler_does_not_import_http_transport(self) -> None:
        ...
        src = inspect.getsource(cccc_group_bridge)
