...
class TestFederationContracts(unittest.TestCase):
    ...
    def test_registration_record_has_no_raw_token_field(self) -> None:
        from cccc.contracts.v1.federation import RegistrationRecord
    ...
    def test_receipt_and_error_roundtrip(self) -> None:
        from cccc.contracts.v1.federation import RemoteSendError, RemoteSendReceipt
    ...
    def test_envelope_wraps_payload(self) -> None:
        from cccc.contracts.v1.federation import RemoteSendEnvelope, RemoteSendPayload
