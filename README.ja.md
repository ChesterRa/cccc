...
Claude Code、Codex、ChatGPT Web など 12 のランタイムをひとつの永続グループで。**
...
| **マルチランタイム編成** | Claude Code、Codex CLI、Devin CLI、Kiro CLI、Grok Build、OpenCode、ChatGPT Web など 12 種の主要ランタイムを混在利用でき、さらに `custom` も扱える |
