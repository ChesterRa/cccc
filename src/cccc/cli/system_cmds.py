...
def cmd_doctor(args: argparse.Namespace) -> int:
    ...
    if available_count == 0:
        ...
        print("First-class supported runtimes: claude, codex, droid, amp, auggie, gemini, grok, hermes, kimi, opencode")
...
def cmd_setup(args: argparse.Namespace) -> int:
    ...
    # Supported runtimes
    # - claude/codex/droid/amp/auggie/gemini/grok/hermes/kimi: MCP setup can be automated via their CLIs
    ...
    def _auto_setup(rt: str) -> None:
        if rt == "opencode":
            ...
            results["mcp"][rt] = {
                "mode": "auto",
                "status": "runtime_env",
                "hint": "CCCC injects the OpenCode MCP config through OPENCODE_CONFIG_CONTENT when each actor starts; no global OpenCode config is modified.",
            }
