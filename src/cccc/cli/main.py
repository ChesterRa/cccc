...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_actor_add.add_argument(
        "--runtime",
        choices=["claude", "cline", "codex", "deepseek", "copilot", "cursor", "devin", "kiro", "kilo", "antigravity", "droid", "amp", "auggie", "grok", "hermes", "kimi", "opencode", "custom"],
        default="codex",
    ...
    p_actor_update.add_argument("--runtime", choices=["claude", "cline", "codex", "deepseek", "copilot", "cursor", "devin", "kiro", "kilo", "antigravity", "droid", "amp", "auggie", "grok", "hermes", "kimi", "opencode", "custom"], default=None, help="New runtime")
