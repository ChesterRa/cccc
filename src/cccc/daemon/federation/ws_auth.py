"""Authentication helpers for federation WebSocket sessions."""
...
from .identity import canonical_payload_bytes, get_federation_identity, peer_id_from_public_key_b64

PROTOCOL_ID = "/cccc/federation/session-ws/1.0.0"
...
def sign_session_hello(hello: Dict[str, Any], *, home: Optional[Path] = None) -> Dict[str, Any]:
    identity = get_federation_identity(home=home)
