...
def render_install_command_task(command: Dict[str, str]) -> str:
    ...
    lines = [
        ...
        "The install operation must import registry records from capability ids, repos, URLs, or local SKILL.md paths; enable actor scope; and return use-ready capability ids.",
