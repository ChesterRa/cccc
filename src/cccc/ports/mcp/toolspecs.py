        ...
        "inputSchema": _obj(
            {
                ...
                **_COMMON_ACTOR,
                ...
                "draft_text": {"type": "string", "description": "Composer text to insert. Required unless no_op=true. Follow the prompt_refine Operation: append operations return an addition; replace operations return a complete replacement."},
                "no_op": {"type": "boolean", "description": "Set true only when the prompt_refine result should make no composer change, such as empty or non-substantive speech."},
