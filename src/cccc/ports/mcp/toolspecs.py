...
MCP_TOOLS = [
    ...
    {
        "name": "cccc_memory",
        "description": "ReMe file-memory primary ops: action=layout_get|search|get|write|promote_experience|govern_experience|repair_experience|report_skill_usage|govern_skill_patch.",
        "inputSchema": _obj(
            {
                **_COMMON_GROUP,
                "action": {
                    "type": "string",
                    "enum": ["layout_get", "search", "get", "write", "promote_experience", "govern_experience", "repair_experience", "report_skill_usage", "govern_skill_patch"],
                    "default": "search",
                },
                "query": {"type": "string"},
                ...
                "evidence_payload": {"type": "object"},
                "outcome": {"type": "string"},
                "generate_patch": {"type": "boolean", "default": False},
                "patch_kind": {"type": "string", "enum": ["add_step", "remove_step", "adjust_constraint", "clarify_failure_signal"]},
                "proposed_delta": {"type": "object"},
                "dry_run": {"type": "boolean", "default": False},
                "lifecycle_action": {"type": "string", "enum": ["reject", "merge", "supersede"]},
